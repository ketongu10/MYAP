...
experiment_name = f"time={SIM_TIME}_nv={N_v}_nx={N_x}_ny={N_y}_T={T2}_njit_full_out_wideQ"
...
def start_2d(F, V,dx, dy, dt):
    ...
    for t in range(SIM_TIME):
        ...
        #CALC_COLL_INT(F, N_integral, buffered_mesh, (N_x, N_y), dt, use_all_mesh=False)
